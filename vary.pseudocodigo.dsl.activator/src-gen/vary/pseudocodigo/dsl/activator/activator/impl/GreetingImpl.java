 ...
 * <ul>
 *   <li>{@link vary.pseudocodigo.dsl.activator.activator.impl.GreetingImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GreetingImpl extends MinimalEObjectImpl.Container implements Greeting
{
  ...
  {
    return ActivatorPackage.Literals.GREETING;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ActivatorPackage.GREETING__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ActivatorPackage.GREETING__NAME:
        return getName();
    }
