...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Asignacion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AsignacionItemProvider
	 ...
	 * @generated
	 */
	public AsignacionItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addValor_asignacionPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Asignacion_Mat_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Asignacion_Mat_feature", "_UI_Asignacion_type"),
				 DiagramapseudocodigoPackage.Literals.ASIGNACION__MAT,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Valor asignacion feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addValor_asignacionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Asignacion_valor_asignacion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Asignacion_valor_asignacion_feature", "_UI_Asignacion_type"),
				 DiagramapseudocodigoPackage.Literals.ASIGNACION__VALOR_ASIGNACION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.ASIGNACION__OPERADORES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Asignacion"));
	}
	...
	public String getText(Object object) {
		String label = ((Asignacion)object).getValor_asignacion();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramapseudocodigoPackage.Literals.ASIGNACION__OPERADORES,
