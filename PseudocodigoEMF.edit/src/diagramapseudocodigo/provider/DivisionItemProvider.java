...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Division} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DivisionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Division_signo_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Division_signo_op_feature", "_UI_Division_type"),
				 DiagramapseudocodigoPackage.Literals.DIVISION__SIGNO_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.DIVISION__LEFT);
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.DIVISION__RIGHT);
		}
	...
	public String getText(Object object) {
		signo labelValue = ((Division)object).getSigno_op();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Division.class)) {
			case DiagramapseudocodigoPackage.DIVISION__SIGNO_OP:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DiagramapseudocodigoPackage.DIVISION__LEFT:
			case DiagramapseudocodigoPackage.DIVISION__RIGHT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramapseudocodigoPackage.Literals.DIVISION__LEFT,
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramapseudocodigoPackage.Literals.DIVISION__RIGHT,
				 DiagramapseudocodigoFactory.eINSTANCE.createLlamadaFuncion()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DiagramapseudocodigoPackage.Literals.DIVISION__LEFT ||
			childFeature == DiagramapseudocodigoPackage.Literals.DIVISION__RIGHT;
