...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Suma} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SumaItemProvider
	 ...
	 * @generated
	 */
	public SumaItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Suma_signo_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Suma_signo_op_feature", "_UI_Suma_type"),
				 DiagramapseudocodigoPackage.Literals.SUMA__SIGNO_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.SUMA__LEFT);
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.SUMA__RIGHT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Suma"));
	}
	...
	public String getText(Object object) {
		signo labelValue = ((Suma)object).getSigno_op();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Suma_type") :
			getString("_UI_Suma_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Suma.class)) {
			case DiagramapseudocodigoPackage.SUMA__SIGNO_OP:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DiagramapseudocodigoPackage.SUMA__LEFT:
			case DiagramapseudocodigoPackage.SUMA__RIGHT:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DiagramapseudocodigoPackage.Literals.SUMA__LEFT ||
			childFeature == DiagramapseudocodigoPackage.Literals.SUMA__RIGHT;
