	...
	protected void addOperadoresPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LlamadaFuncion_operadores_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LlamadaFuncion_operadores_feature", "_UI_LlamadaFuncion_type"),
