...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.operando_izq} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class operando_izqItemProvider
	 ...
	 * @generated
	 */
	public operando_izqItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.OPERANDO_IZQ__OPER_IZQ);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/operando_izq"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_operando_izq_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(operando_izq.class)) {
