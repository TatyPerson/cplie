...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Comparacion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComparacionItemProvider
	 ...
	 * @generated
	 */
	public ComparacionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comparacion_signo_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comparacion_signo_op_feature", "_UI_Comparacion_type"),
				 DiagramapseudocodigoPackage.Literals.COMPARACION__SIGNO_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.COMPARACION__LEFT);
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.COMPARACION__RIGHT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Comparacion"));
	}
	...
	public String getText(Object object) {
		signo labelValue = ((Comparacion)object).getSigno_op();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Comparacion_type") :
			getString("_UI_Comparacion_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Comparacion.class)) {
			case DiagramapseudocodigoPackage.COMPARACION__SIGNO_OP:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DiagramapseudocodigoPackage.COMPARACION__LEFT:
			case DiagramapseudocodigoPackage.COMPARACION__RIGHT:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DiagramapseudocodigoPackage.Literals.COMPARACION__LEFT ||
			childFeature == DiagramapseudocodigoPackage.Literals.COMPARACION__RIGHT;
