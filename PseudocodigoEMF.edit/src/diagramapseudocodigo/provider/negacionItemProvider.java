...
public class negacionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_negacion_nombre_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_negacion_nombre_feature", "_UI_negacion_type"),
				 DiagramapseudocodigoPackage.Literals.NEGACION__NOMBRE,
				 true,
				 false,
				 false,
	...
	protected void addSsignoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_negacion_ssigno_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_negacion_ssigno_feature", "_UI_negacion_type"),
				 DiagramapseudocodigoPackage.Literals.NEGACION__SSIGNO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((negacion)object).getNombre();
		return label == null || label.length() == 0 ?
			getString("_UI_negacion_type") :
			getString("_UI_negacion_type") + " " + label;
	}
