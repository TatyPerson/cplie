...
public class operacionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_operacion_signo_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_operacion_signo_op_feature", "_UI_operacion_type"),
				 DiagramapseudocodigoPackage.Literals.OPERACION__SIGNO_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.OPERACION__OP_IZQ);
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.OPERACION__OP_DER);
		}
	...
	public String getText(Object object) {
		signo labelValue = ((operacion)object).getSigno_op();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramapseudocodigoPackage.Literals.OPERACION__OP_IZQ,
				 DiagramapseudocodigoFactory.eINSTANCE.createoperando_izq()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramapseudocodigoPackage.Literals.OPERACION__OP_DER,
				 DiagramapseudocodigoFactory.eINSTANCE.createoperando_der()));
	}
