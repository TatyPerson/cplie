		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPrimariaAccess().getAlternatives_7_1_2(), "rule__Primaria__Alternatives_7_1_2");
					put(grammarAccess.getPrimariaAccess().getAlternatives_7_1_4(), "rule__Primaria__Alternatives_7_1_4");
					put(grammarAccess.getPrimariaAccess().getAlternatives_8_1_2(), "rule__Primaria__Alternatives_8_1_2");
					...
					put(grammarAccess.getPrimariaAccess().getGroup_8(), "rule__Primaria__Group_8__0");
					put(grammarAccess.getPrimariaAccess().getGroup_8_1(), "rule__Primaria__Group_8_1__0");
					put(grammarAccess.getPrimariaAccess().getGroup_8_2(), "rule__Primaria__Group_8_2__0");
					put(grammarAccess.getPrimariaAccess().getGroup_9(), "rule__Primaria__Group_9__0");
					put(grammarAccess.getPrimariaAccess().getGroup_9_3(), "rule__Primaria__Group_9_3__0");
					put(grammarAccess.getPrimariaAccess().getGroup_9_3_1(), "rule__Primaria__Group_9_3_1__0");
					put(grammarAccess.getPrimariaAccess().getGroup_10(), "rule__Primaria__Group_10__0");
					put(grammarAccess.getPrimariaAccess().getGroup_10_3(), "rule__Primaria__Group_10_3__0");
					put(grammarAccess.getPrimariaAccess().getGroup_10_3_1(), "rule__Primaria__Group_10_3_1__0");
					put(grammarAccess.getPrimariaAccess().getGroup_11(), "rule__Primaria__Group_11__0");
					put(grammarAccess.getPrimariaAccess().getGroup_11_3(), "rule__Primaria__Group_11_3__0");
					put(grammarAccess.getPrimariaAccess().getGroup_11_3_1(), "rule__Primaria__Group_11_3_1__0");
					...
					put(grammarAccess.getPrimariaAccess().getValorAssignment_1_1(), "rule__Primaria__ValorAssignment_1_1");
					put(grammarAccess.getPrimariaAccess().getValorAssignment_2_1(), "rule__Primaria__ValorAssignment_2_1");
					put(grammarAccess.getPrimariaAccess().getContenidoAssignment_3_1(), "rule__Primaria__ContenidoAssignment_3_1");
					put(grammarAccess.getPrimariaAccess().getContenidoAssignment_4_1(), "rule__Primaria__ContenidoAssignment_4_1");
					put(grammarAccess.getPrimariaAccess().getValorAssignment_5_1(), "rule__Primaria__ValorAssignment_5_1");
					put(grammarAccess.getPrimariaAccess().getNombreAssignment_6_1(), "rule__Primaria__NombreAssignment_6_1");
					put(grammarAccess.getPrimariaAccess().getNombre_matrizAssignment_7_1_0(), "rule__Primaria__Nombre_matrizAssignment_7_1_0");
					put(grammarAccess.getPrimariaAccess().getIndicesCadenaAssignment_7_1_2_0(), "rule__Primaria__IndicesCadenaAssignment_7_1_2_0");
					put(grammarAccess.getPrimariaAccess().getIndicesNumericosAssignment_7_1_2_1(), "rule__Primaria__IndicesNumericosAssignment_7_1_2_1");
					put(grammarAccess.getPrimariaAccess().getIndicesCadenaAssignment_7_1_4_0(), "rule__Primaria__IndicesCadenaAssignment_7_1_4_0");
					put(grammarAccess.getPrimariaAccess().getIndicesNumericosAssignment_7_1_4_1(), "rule__Primaria__IndicesNumericosAssignment_7_1_4_1");
					put(grammarAccess.getPrimariaAccess().getCampoAssignment_7_2_1(), "rule__Primaria__CampoAssignment_7_2_1");
					put(grammarAccess.getPrimariaAccess().getNombre_vectorAssignment_8_1_0(), "rule__Primaria__Nombre_vectorAssignment_8_1_0");
					put(grammarAccess.getPrimariaAccess().getIndiceCadenaAssignment_8_1_2_0(), "rule__Primaria__IndiceCadenaAssignment_8_1_2_0");
					put(grammarAccess.getPrimariaAccess().getIndiceNumericoAssignment_8_1_2_1(), "rule__Primaria__IndiceNumericoAssignment_8_1_2_1");
					put(grammarAccess.getPrimariaAccess().getCampoAssignment_8_2_1(), "rule__Primaria__CampoAssignment_8_2_1");
					put(grammarAccess.getPrimariaAccess().getNombre_registroAssignment_9_1(), "rule__Primaria__Nombre_registroAssignment_9_1");
					put(grammarAccess.getPrimariaAccess().getCampoAssignment_9_3_0(), "rule__Primaria__CampoAssignment_9_3_0");
					put(grammarAccess.getPrimariaAccess().getCampoAssignment_9_3_1_1(), "rule__Primaria__CampoAssignment_9_3_1_1");
					put(grammarAccess.getPrimariaAccess().getNombreAssignment_10_1(), "rule__Primaria__NombreAssignment_10_1");
					put(grammarAccess.getPrimariaAccess().getOperadoresAssignment_10_3_0(), "rule__Primaria__OperadoresAssignment_10_3_0");
					put(grammarAccess.getPrimariaAccess().getOperadoresAssignment_10_3_1_1(), "rule__Primaria__OperadoresAssignment_10_3_1_1");
					put(grammarAccess.getPrimariaAccess().getNombreAssignment_11_1(), "rule__Primaria__NombreAssignment_11_1");
					put(grammarAccess.getPrimariaAccess().getOperadoresAssignment_11_3_0(), "rule__Primaria__OperadoresAssignment_11_3_0");
					put(grammarAccess.getPrimariaAccess().getOperadoresAssignment_11_3_1_1(), "rule__Primaria__OperadoresAssignment_11_3_1_1");
