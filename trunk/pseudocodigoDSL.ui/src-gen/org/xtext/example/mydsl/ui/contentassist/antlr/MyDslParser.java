		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCodigoAccess().getGroup_2_1(), "rule__Codigo__Group_2_1__0");
					...
					put(grammarAccess.getCodigoAccess().getComentariosAssignment_0_0(), "rule__Codigo__ComentariosAssignment_0_0");
					put(grammarAccess.getCodigoAccess().getComentariosAssignment_0_1(), "rule__Codigo__ComentariosAssignment_0_1");
					put(grammarAccess.getCodigoAccess().getConstantesAssignment_1_1_0(), "rule__Codigo__ConstantesAssignment_1_1_0");
					put(grammarAccess.getCodigoAccess().getConstantesAssignment_1_1_1(), "rule__Codigo__ConstantesAssignment_1_1_1");
					put(grammarAccess.getCodigoAccess().getTipocomplejoAssignment_2_1_0(), "rule__Codigo__TipocomplejoAssignment_2_1_0");
					put(grammarAccess.getCodigoAccess().getTipocomplejoAssignment_2_1_1(), "rule__Codigo__TipocomplejoAssignment_2_1_1");
					put(grammarAccess.getCodigoAccess().getFuncionAssignment_3_0(), "rule__Codigo__FuncionAssignment_3_0");
					put(grammarAccess.getCodigoAccess().getFuncionAssignment_3_1(), "rule__Codigo__FuncionAssignment_3_1");
					put(grammarAccess.getCodigoAccess().getTieneAssignment_4(), "rule__Codigo__TieneAssignment_4");
