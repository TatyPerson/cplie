...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.desde} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class desdeItemProvider
	 ...
	 * @generated
	 */
	public desdeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.DESDE__ASIGNACION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/desde"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_desde_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(desde.class)) {
