...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Or} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Or_signo_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Or_signo_op_feature", "_UI_Or_type"),
				 DiagramapseudocodigoPackage.Literals.OR__SIGNO_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.OR__LEFT);
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.OR__RIGHT);
		}
	...
	public String getText(Object object) {
		signo labelValue = ((Or)object).getSigno_op();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramapseudocodigoPackage.Literals.OR__LEFT,
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramapseudocodigoPackage.Literals.OR__RIGHT,
				 DiagramapseudocodigoFactory.eINSTANCE.createLlamadaFuncion()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DiagramapseudocodigoPackage.Literals.OR__LEFT ||
			childFeature == DiagramapseudocodigoPackage.Literals.OR__RIGHT;
