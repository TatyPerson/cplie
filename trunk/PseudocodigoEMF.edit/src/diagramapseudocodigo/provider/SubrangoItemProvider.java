	...
	protected void addLimite_infPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subrango_limite_inf_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subrango_limite_inf_feature", "_UI_Subrango_type"),
	...
	protected void addLimite_supPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subrango_limite_sup_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subrango_limite_sup_feature", "_UI_Subrango_type"),
