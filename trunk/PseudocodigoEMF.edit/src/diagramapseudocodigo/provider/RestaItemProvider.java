...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Resta} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RestaItemProvider
	 ...
	 * @generated
	 */
	public RestaItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resta_signo_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resta_signo_op_feature", "_UI_Resta_type"),
				 DiagramapseudocodigoPackage.Literals.RESTA__SIGNO_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.RESTA__LEFT);
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.RESTA__RIGHT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Resta"));
	}
	...
	public String getText(Object object) {
		signo labelValue = ((Resta)object).getSigno_op();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Resta_type") :
			getString("_UI_Resta_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Resta.class)) {
			case DiagramapseudocodigoPackage.RESTA__SIGNO_OP:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DiagramapseudocodigoPackage.RESTA__LEFT:
			case DiagramapseudocodigoPackage.RESTA__RIGHT:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DiagramapseudocodigoPackage.Literals.RESTA__LEFT ||
			childFeature == DiagramapseudocodigoPackage.Literals.RESTA__RIGHT;
