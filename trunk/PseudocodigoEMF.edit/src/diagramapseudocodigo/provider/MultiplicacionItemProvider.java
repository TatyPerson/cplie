...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Multiplicacion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiplicacionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Multiplicacion_signo_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Multiplicacion_signo_op_feature", "_UI_Multiplicacion_type"),
				 DiagramapseudocodigoPackage.Literals.MULTIPLICACION__SIGNO_OP,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.MULTIPLICACION__LEFT);
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.MULTIPLICACION__RIGHT);
		}
	...
	public String getText(Object object) {
		signo labelValue = ((Multiplicacion)object).getSigno_op();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Multiplicacion.class)) {
			case DiagramapseudocodigoPackage.MULTIPLICACION__SIGNO_OP:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case DiagramapseudocodigoPackage.MULTIPLICACION__LEFT:
			case DiagramapseudocodigoPackage.MULTIPLICACION__RIGHT:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DiagramapseudocodigoPackage.Literals.MULTIPLICACION__LEFT ||
			childFeature == DiagramapseudocodigoPackage.Literals.MULTIPLICACION__RIGHT;
