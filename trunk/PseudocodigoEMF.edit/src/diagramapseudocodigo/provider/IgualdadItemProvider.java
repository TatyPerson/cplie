...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Igualdad} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IgualdadItemProvider
	 ...
	 * @generated
	 */
	public IgualdadItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Igualdad_signo_op_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Igualdad_signo_op_feature", "_UI_Igualdad_type"),
				 DiagramapseudocodigoPackage.Literals.IGUALDAD__SIGNO_OP,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Igualdad"));
	}
	...
	public String getText(Object object) {
		signo labelValue = ((Igualdad)object).getSigno_op();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Igualdad_type") :
			getString("_UI_Igualdad_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Igualdad.class)) {
