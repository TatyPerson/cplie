...
/**
 * This is the item provider adapter for a {@link diagramapseudocodigo.Funcion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FuncionItemProvider
	 ...
	 * @generated
	 */
	public FuncionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Funcion_tipo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Funcion_tipo_feature", "_UI_Funcion_type"),
				 DiagramapseudocodigoPackage.Literals.FUNCION__TIPO,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiagramapseudocodigoPackage.Literals.FUNCION__DEVUELVE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Funcion"));
	}
	...
	public String getText(Object object) {
		String label = ((Funcion)object).getNombre();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Funcion.class)) {
