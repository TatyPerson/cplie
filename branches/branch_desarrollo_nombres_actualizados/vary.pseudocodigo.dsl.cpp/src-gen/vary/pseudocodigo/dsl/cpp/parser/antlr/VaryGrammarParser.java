...
public class VaryGrammarParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected vary.pseudocodigo.dsl.cpp.parser.antlr.internal.InternalVaryGrammarParser createParser(XtextTokenStream stream) {
		return new vary.pseudocodigo.dsl.cpp.parser.antlr.internal.InternalVaryGrammarParser(stream, getGrammarAccess());
	}
