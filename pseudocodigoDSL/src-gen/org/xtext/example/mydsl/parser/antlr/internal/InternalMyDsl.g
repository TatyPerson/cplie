...
(
    ...
    { 
        $current = $this_Asignacion_2.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_Escribir_3.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_mientras_6.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_repetir_7.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_incremento_9.current; 
        afterParserOrEnumRuleCall();
    }
)
;
