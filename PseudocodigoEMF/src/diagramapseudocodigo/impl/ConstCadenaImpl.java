...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Const Cadena</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link diagramapseudocodigo.impl.ConstCadenaImpl#getContenido <em>Contenido</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConstCadenaImpl extends OperadorImpl implements ConstCadena {
	/**
	...
	public void setContenido(String newContenido) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramapseudocodigoPackage.CONST_CADENA__CONTENIDO, oldContenido, contenido));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DiagramapseudocodigoPackage.CONST_CADENA__CONTENIDO:
				return getContenido();
		}
