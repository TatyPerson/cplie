		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPrimariaAccess().getNombre_vectorAssignment_5_1_0(), "rule__Primaria__Nombre_vectorAssignment_5_1_0");
					put(grammarAccess.getPrimariaAccess().getIndiceAssignment_5_1_2(), "rule__Primaria__IndiceAssignment_5_1_2");
					put(grammarAccess.getPrimariaAccess().getCampoAssignment_5_2_1(), "rule__Primaria__CampoAssignment_5_2_1");
					put(grammarAccess.getPrimariaAccess().getNombre_matrizAssignment_6_1_0(), "rule__Primaria__Nombre_matrizAssignment_6_1_0");
					put(grammarAccess.getPrimariaAccess().getPrimerIndiceAssignment_6_1_2(), "rule__Primaria__PrimerIndiceAssignment_6_1_2");
					put(grammarAccess.getPrimariaAccess().getSegundoIndiceAssignment_6_1_4(), "rule__Primaria__SegundoIndiceAssignment_6_1_4");
